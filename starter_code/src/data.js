...
//average rates
  ...
  let sumRate = movies.rate.map.reduce((base,elem){
      sumRate=(base + elem);
  return sumRate = (sumRate/movies.length).toFixed(2);
	});
console.log(sumRate);
console.log(movies);
...
let newMoviesdursort = movies.sort(function(a,b){
  return a.duration-b.duration;
});
console.log(newMoviesdursort);

// How many movies did STEVEN SPIELBERG
let spielberg = movies.filter(function(elem){
